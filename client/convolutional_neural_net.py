...
class ConvNet:
    def __init__(self, input_shape, action_space):
        ...
        x = layers.Conv2D(32, 8, strides=(4, 4), padding="valid", activation="relu", input_shape=input_shape, data_format="channels_first")(conv_input)
        x = layers.Conv2D(64, 4, strides=(2, 2), padding="valid", activation="relu", input_shape=input_shape, data_format="channels_first")(x)
        x = layers.Conv2D(64, 3, strides=(1, 1), padding="valid", activation="relu", input_shape=input_shape, data_format="channels_first")(x)
        x = layers.Flatten()(x)
